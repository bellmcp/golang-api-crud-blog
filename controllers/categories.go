...
func (c *Categories) FindAll(ctx *gin.Context) {
	...
	var serializedCategoroies []allCategoryResponse
	copier.Copy(&serializedCategoroies, &categories)
	ctx.JSON(http.StatusOK, gin.H{"categories": serializedCategoroies})
}
...
func (c *Categories) FindOne(ctx *gin.Context) {
	...
	copier.Copy(&serializeCategoryResponse, &category)
	ctx.JSON(http.StatusOK, gin.H{"category": serializeCategoryResponse})
}
...
func (c *Categories) Delete(ctx *gin.Context) {
	...
	c.DB.Unscoped().Delete(&category) // hard delete
